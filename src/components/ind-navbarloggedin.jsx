                ...
                <div class="dropdown-menu dropdown-menu-end position-absolute mx-3 my-5">
                  <div class="dropdown-item">
                    <div class="d-flex">
                      ...
                      <div class="ms-3 lh-1">
                        <h5 class="mb-1">Rajat B</h5>
                        <p class="mb-0">rajat@geeks.com</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li>
                      <a class="dropdown-item" href="/userdocs" target="_blank">
                        <i class="fe fe-star me-2"></i>
                        Documents
                      </a>
                    </li>
...
export default IndNavbarLoggedIn;
