          ...
          <div className="row g-4 align-items-center">
            <div className="col-md-6 position-relative">
              ...
              <div className="d-lg-flex mb-4">
                <a href="#" className="btn btn-primary me-4 fw-medium">
                  Get Started
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
            ...
            <div className="card border-0 shadow h-100 text-center text-sm-start p-3 mx-2">
              <div className="card-body">
                ...
                <h3 className="h1 pt-4 mb-1 fw-bold">
                  50 <span className="h4 fw-bold">Years</span>
                </h3>
          ...
          >
            <div className="card border-0 shadow h-100 text-center text-sm-start p-3 mx-2">
              <div className="card-body">
                ...
                <h3 className="h1 pt-4 mb-1 fw-bold">
                  100+ <span className="h4 fw-bold">Clients</span>
                </h3>
                <p className="fs-lg mb-0 fw-light" id="grey-text">
                  Satisfied
                </p>
